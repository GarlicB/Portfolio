...
public class SheetMusic extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public static final int PageWidth = 960;    /** The width of each page */
    public static final int PageHeight = 1260;  /** The height of each page (when printing) */
    public static final int TitleHeight = 18;   /** Height of title on first page */
